...
README from chat-langchain below, modified to reflect changes
...
The app is meant to leverage LangChain's streaming support and async API to update the page in real time for multiple users.

## ✅ Running locally
1. Install dependencies: `pip install -r requirements.txt`
1. Run `ingest.sh` to ingest pdfs into the vectorstore (only needs to be done once).
...
2. Load html with LangChain's [PDFDirectoryLoader]
